...
parser = argparse.ArgumentParser(description="Process Ginkgo bin files (such as variable_2500000_150_bowtie) and outputs bed files converted from the input")
